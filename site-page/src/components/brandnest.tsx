...
const Brandnest = () => {
  ...
  return (
    <div className="relative h-[100vh] w-full bg-gradient-to-br from-purple-50 to-blue-50">
      <div className={`absolute flex items-center justify-center mt-10 w-[350px] md:w-[600px] mx-auto bg-white rounded-lg shadow-xl overflow-hidden${snippet ? "" : "inset-0" } `}>
